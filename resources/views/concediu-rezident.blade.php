...
<div class = "container">
  <a href="cont" class="return-cont">
        ...
        <div class="return-text">Disponibilitate rezident</div>
    </a>
   <div class="descriere">Alege in ce perioada esti disponibil sa inlocuiesti un doctor.</div>
  <div class = "calendar-container">
     ...
     <div class = "calendar-left-inside">
       ...
       <div class = "calendar-left-inside-ora">
        <div class = "calendar-ora">
          ...
          <div class = "ora-person"><img src = "images/poza-fata.svg" class = "width"></div>
          <form class = "ora-elemente" action='{{ action("AccountController@concediu_rezident") }}' method="post">
    ...
    <div class ="calendar-right">
      ...
      <div class = "calendar-person" data-aos="fade-right"  data-aos-delay="200"  data-aos-duration="600" ><img src = "images/rezident1-img.svg" class = "width"> </div>
    </div>
  </div>
</div>
@endsection
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      $('#trimite-calendar').on('click', function (event) {
        ...
        $.ajax({
          method: 'POST',
          url: '{{ action("AccountController@concediu_rezident") }}',
